...
core t_any McoreFNmonth(t_thrd_data* const thrd_data, const t_any* const args) {
     const char* const owner = "function - core.month";
     ...
     return (const t_any){.structure = {.value = month, .type = tid__int}};
}