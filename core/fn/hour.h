...
core t_any McoreFNhour(t_thrd_data* const thrd_data, const t_any* const args) {
     const char* const owner = "function - core.hour";
     ...
     return (const t_any){.structure = {.value = hour, .type = tid__int}};
}