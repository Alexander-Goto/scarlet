...
core t_any McoreFNsecond(t_thrd_data* const thrd_data, const t_any* const args) {
     const char* const owner = "function - core.second";
     ...
     return (const t_any){.structure = {.value = second, .type = tid__int}};
}