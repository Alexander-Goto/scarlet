...
core t_any McoreFNminute(t_thrd_data* const thrd_data, const t_any* const args) {
     const char* const owner = "function - core.minute";
     ...
     return (const t_any){.structure = {.value = minute, .type = tid__int}};
}