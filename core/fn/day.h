...
core t_any McoreFNday(t_thrd_data* const thrd_data, const t_any* const args) {
     const char* const owner = "function - core.day";
     ...
     return (const t_any){.structure = {.value = day, .type = tid__int}};
}
