...
core t_any McoreFNmax(t_thrd_data* const thrd_data, const t_any* const args) {
     const char* const owner = "function - core.max";
     ...
     case tid__short_string:
          switch (arg_2_type) {
          case tid__short_string:
               return cmp__short_string__short_string(arg_1, arg_2).bytes[0] == less_id ? arg_2 : arg_1;
          case tid__string:
               if (cmp__short_string__long_string(arg_1, arg_2).bytes[0] == less_id) return arg_2;
               ref_cnt__dec(thrd_data, arg_2);
               return arg_1;
          default:
               unreachable;
     ...
     case tid__string:
          switch (arg_2_type) {
          case tid__short_string:
               if (cmp__long_string__short_string(arg_1, arg_2).bytes[0] == less_id) {
                    ref_cnt__dec(thrd_data, arg_1);
                    return arg_2;
               }
               ...
               return arg_1;
          case tid__string:
               if (cmp__long_string__long_string(arg_1, arg_2).bytes[0] == less_id) {
                    ref_cnt__dec(thrd_data, arg_1);
                    return arg_2;
               }
               ref_cnt__dec(thrd_data, arg_2);
     ...
     case tid__short_byte_array: case tid__byte_array:
          if (byte_array__cmp(arg_1, arg_2).bytes[0] == less_id) {
               ref_cnt__dec(thrd_data, arg_1);
               return arg_2;
          }
