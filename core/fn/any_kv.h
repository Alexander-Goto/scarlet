...
[[gnu::hot]]
core t_any McoreFNany_kv(t_thrd_data* const thrd_data, const t_any* const args) {
     const char* const owner = "function - core.any_kv";
     ...
     case tid__short_string: case tid__string: {
          ...
          t_any const result = string__any_kv__own(thrd_data, container, default_result, fn, owner);
     ...
     case tid__short_byte_array: case tid__byte_array: {
          call_stack__push(thrd_data, owner);
          t_any const result = byte_array__any_kv__own(thrd_data, container, default_result, fn, owner);
          call_stack__pop(thrd_data);
     ...
     case tid__obj: {
          call_stack__push(thrd_data, owner);
          t_any const result = obj__any_kv__own(thrd_data, container, default_result, fn, owner);
          call_stack__pop(thrd_data);
     ...
     case tid__table: {
          call_stack__push(thrd_data, owner);
          t_any const result = table__any_kv__own(thrd_data, container, default_result, fn, owner);
          call_stack__pop(thrd_data);
     ...
     case tid__array: {
          call_stack__push(thrd_data, owner);
          t_any const result = array__any_kv__own(thrd_data, container, default_result, fn, owner);
          call_stack__pop(thrd_data);
     ...
     case tid__custom: {
          call_stack__push(thrd_data, owner);
          t_any const result = custom__call__own(thrd_data, mtd__core_any_kv, tid__bool, container, args, 3, owner);
          call_stack__pop(thrd_data);
