...
t_any MstdFNdelete_empty_dir(t_thrd_data* const thrd_data, const t_any* const args) {
     const char* const owner = "function - std.delete_empty_dir";
     ...
     case EEXIST: case ENOTEMPTY:                  return tkn__not_empty;
